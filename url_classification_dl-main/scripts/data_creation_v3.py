...
class UrlFeaturizer(object):
    ...
    def numDots(self):
        digits = [i for i in self.url if i == '.']
        return len(digits)
    
    def numSemicolon(self):
        digits = [i for i in self.url if i == ';']
        return len(digits)
    ...
    def numUnderscore(self):
        digits = [i for i in self.url if i == '_']
        return len(digits)
    ...
    def run(self):
        ...
        data['domDigitStart'] = self.domDigitStart()
        data['numDigits'] = self.numDigits()
        data['numDots'] = self.numDots()
        data['numSemicolon'] = self.numSemicolon()
        data['numAmpersand'] = self.numAmpersand()
        data['numSlash'] = self.numSlash()
        data['numHyphen'] = self.numHyphen()
        data['numUnderscore'] = self.numUnderscore()
        data['numEqual'] = self.numEqual()
        data['numQuestion'] = self.numQuestion()
